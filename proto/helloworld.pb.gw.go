...
func request_Greeter_SayWord_0(ctx context.Context, client GreeterClient, req *http.Request, pathParams map[string]string) (proto.Message, error) {
	var protoReq MyMessage

	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_Greeter_SayWord_0); err != nil {
		return nil, grpc.Errorf(codes.InvalidArgument, "%v", err)
	}

	return client.SayWord(ctx, &protoReq)
}
...
func RegisterGreeterHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("GET", pattern_Greeter_SayWord_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Greeter_SayWord_0(ctx, w, req, resp, mux.GetForwardResponseOptions()...)
